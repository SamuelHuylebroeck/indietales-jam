...
draw_roundrect_colour_ext(width-220, 30, width-30, 70, 20, 20, c_black, c_black, false);

draw_text_transformed(width-140, 40, "SPEED BOOST", 0.6, 0.6, 0)

draw_circle_colour(width-50, 50, 10, rect_color, rect_color, false);